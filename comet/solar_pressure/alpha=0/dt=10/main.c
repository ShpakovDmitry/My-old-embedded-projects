...
{
				//     x             y     vx     vy          R
	double   comet[4][7] = { { 35.0823105*au, 0.0*au, 0.0,  911.5178, 1.019e12	},	// r =    100 m
				 { 35.0823105*au, 0.0*au, 0.0,  911.5178, 2.037e11	},	// r =    500 m
				 { 35.0823105*au, 0.0*au, 0.0,  911.5178, 1.019e11	},	// r =  1'000 m
				 { 35.0823105*au, 0.0*au, 0.0,  911.5178, 6.791e9	} };	// r = 15'000 m
