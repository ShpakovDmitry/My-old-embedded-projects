...
{
				//     x             y     vx     vy          R
	double   comet[4][7] = { { 35.0823105*au, 0.0*au, 0.0,  911.5178, 6.2832e+09	},
				 { 35.0823105*au, 0.0*au, 0.0,  911.5178, 7.8540e+11	},
				 { 35.0823105*au, 0.0*au, 0.0,  911.5178, 6.2832e+12	},
				 { 35.0823105*au, 0.0*au, 0.0,  911.5178, 2.1206e+16	} };
